      ...
      <main className="wishlist-page__main">
        <div className="wishlist-page__container">
          <div className="wishlist-page__header">
            <Heart className="wishlist-page__icon" size={32} />
            <h1>My Wishlist</h1>
          </div>
          ...
          {wishlist.length === 0 ? (
            <div className="wishlist-page__empty">
              ...
              <a href="/" className="wishlist-page__button">Continue Shopping</a>
            </div>
          ) : (
            <div className="wishlist-page__grid">
              {wishlist.map(product => (
                <article key={product.id} className="wishlist-page__card">
                  <div className="wishlist-page__image">
                    <img src={product.image} alt={product.name} loading="lazy" />
                  </div>
                  <div className="wishlist-page__content">
                    <h3>{product.name}</h3>
                    <p className="wishlist-page__category">{product.category}</p>
                    {product.price && <p className="wishlist-page__price">{product.price}</p>}
